...
class AuthorshipConsistencyTests(unittest.TestCase):
    ...
    def test_notices_do_not_attribute_this_model_to_entropy_data(self):
        ...
        self.assertIn("grateful thanks to", template)
        self.assertIn("Simon Harrer", template)
        self.assertIn("Cite this model", template)
        self.assertIn("mccalla2026datalandscapeknowledgemodel", template)
        self.assertIn('href="CITATION.bib"', template)
        self.assertIn("https://github.com/mmccalla/data-landscape-knowledge-model/issues", template)
        self.assertIn("mccalla2026datalandscapeknowledgemodel", citation_bib)
        self.assertIn("harrer2026datalandscape", citation_bib)
