...
class StandaloneGraphPageTest(unittest.TestCase):
    ...
    def test_header_and_footer_credit_upstream_landscapes_without_email(self):
        ...
        self.assertIn("grateful thanks to", self.html)
        self.assertIn("Simon Harrer", self.html)
        self.assertIn("Cite this model", self.html)
        self.assertIn("Plain text (APA-style)", self.html)
        self.assertIn("mccalla2026datalandscapeknowledgemodel", self.html)
        self.assertIn('href="CITATION.bib"', self.html)
